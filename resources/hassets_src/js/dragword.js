...
//ICIBA_HUAYI_Str += '    </div>';
ICIBA_HUAYI_Str += '<div class="icIBahyI-down"><a href="http://www.manchu.work/dicts" onclick="clickCountIndex(26)"  target="_blank">满族空间字典2018</a></div>';
ICIBA_HUAYI_Str += '</div>';
ICIBA_HUAYI_Str += '<script src="'+iciba_huaci_url+'dict" charset="utf-8"></script>';
...
ICIBA_HUAYI_Str += '    <script src="'+iciba_huaci_url+'js/manchu_dragword" charset="utf-8" ></script>';
